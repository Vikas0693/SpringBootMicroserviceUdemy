...
public class FilteringController {
	...
	public MappingJacksonValue retrieveSomeBean() {
		...
		FilterProvider filters = new SimpleFilterProvider().addFilter("SomeBeanFilter", propertyFilter);
	...
	public MappingJacksonValue retrieveListOfSomeBean() {
		List list = Arrays.asList(new SomeBean("value1","value2","value3"),new SomeBean("value21","value22","value23"));
